    ...
    while vid.isOpened():
        ...
        try:
            ...
            if status == "No":
                ...
                cv2.putText(img, "previous rep timing:", (427, 50), cv2.FONT_ITALIC, 0.5, (0, 0, 0), 1, cv2.LINE_AA)
                cv2.putText(img, str(sec), (590, 55), cv2.FONT_ITALIC, 0.75, (0, 0, 0), 1, cv2.LINE_AA)
